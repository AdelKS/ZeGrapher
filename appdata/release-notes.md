...
- Near-complete rewrite of the code base, over years of (discontinued) work
- AI/LLMs have only been used in the few months before the release,
  for brainstorming and non-important tasks (reworked several times to fit my taste)
