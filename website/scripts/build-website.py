...
def read_languages(landing: dict) -> dict:
    ...
    a new language is a folder and the files in it. The 'language' field of the
    front matter of the landing panel gives the name of that language, written
    in that language. The drop-down list at the top of every page shows it.
    """
