...
ColumnLayout {
  ...
  /// @brief the hint shown over the label and over the line edit
  ...
  // one handler for the pair, so the label and the line edit show the same
  // hint. It stays hidden while the field has the focus, where it would cover
